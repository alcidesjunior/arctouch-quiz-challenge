...
extension UIView{
    ...
    /// This function set a high priority to compress a view
    ///- Set padding and from params if you need
    /// - Parameters:
    ///    - who: UIView
    @discardableResult
    func magicHighPriority(_ who: UIView)->Self{
        who.setContentCompressionResistancePriority(UILayoutPriority.defaultHigh, for: .vertical)
        return self
    }
